...
If you choose option with **VPN**, than you need to connect both your ROSbot and your laptop to the same Husarnet network. The guide is [here](https://husarion.com/manuals/rosbot/remote-access/).

## Verifying the Hardware Config

Check the content of `.env` file and choose the LIDAR baudrate and serial port for it:
